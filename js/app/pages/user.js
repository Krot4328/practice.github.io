        ...
        <div class="inside-content">
            ...
            <div class="wrapper">
                ...
                <div v-if="tab == 1">
                            ...
                            <div class="w70 al">
                                <div class="flex cubes">
                                    <div class="w30 clicks">
                                        <div>Clicks</div>
                                        <div class="data-value">{{data.sites[iChart].clicks}}</div>
                                    </div>
                                    <div class="w30 views">
                                        <div>Views</div>
                                        <div class="data-value">{{data.sites[iChart].views}}</div>
                                    </div>
                                    <div class="w30 leads">
                                        <div>Leads</div>
                                        <div class="data-value">{{data.sites[iChart].leads}}</div>
                                    </div>
                                    <div class="w30 ctr">
                                        <div>CTR</div>
                                        <div class="data-value">{{(data.sites[iChart].clicks * 100 / data.sites[iChart].views).toFixed(2)}}%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table userSitesList" v-if="data.sites != ''">
                        <table>
                            <thead>
                                <tr>
                                    <th class="id"></th>
                ...
                <div v-if="tab == 2">
                    ...
                    <div class="table userPaymentsList" v-if="data.payments != ''">
                        <table>
                            <thead>
                                <tr>
                                    <th class="id">#</th>
                    ...
                    <div class="ar" v-if="data.payments == ''">
                        No items
                    </div>
                </div>
                ...
                <div v-if="tab == 0">
                    ...
                    <div class="table userStatsTable" v-if="data.statistics != ''">
                        <table>
                            <thead>
                                <tr>
                                    <th class="id"></th>
                    ...
                    <div class="ar" v-if="data.statistics == ''">
                        No items
                    </div>
                </div>
            </div>
